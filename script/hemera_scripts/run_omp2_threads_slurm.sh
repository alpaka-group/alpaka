...
#SBATCH --output=$results_dir/babelstr-slurminfo-cpu-omp2t-%j-$datetime_now-$commit_hash.out  # Store Slurm metadata here
#SBATCH --error=$results_dir/babelstr-slurminfo-cpu-omp2t-%j-$datetime_now-$commit_hash.err   # Store Slurm errors here
