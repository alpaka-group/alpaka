...
# Function to configure and build the project for cpu-serial
build_cpu_serial() {
...
# Function to submit the benchmark for cpu-serial using Slurm
submit_cpu_serial_benchmark() {
    local preset="cpu-serial"
...
# Submit the benchmark to Slurm to Run
submit_cpu_serial_benchmark
