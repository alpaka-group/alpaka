...
submit_combined_job() {
    ...
    local results_file="$results_dir/babelstream-cpu-serial-$datetime_now-$commit_hash.txt"
    echo "Submitting combined Slurm job (compilation + benchmarking)..."
