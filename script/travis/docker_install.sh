...
then
    ...
    ALPAKA_DOCKER_ENV_LIST+=("--env" "ALPAKA_CUDA_VERSION_MAJOR=${ALPAKA_CUDA_VERSION_MAJOR}")
    ALPAKA_DOCKER_ENV_LIST+=("--env" "ALPAKA_CUDA_VERSION_MINOR=${ALPAKA_CUDA_VERSION_MINOR}")
