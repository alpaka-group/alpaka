...
namespace alpaka
{
    namespace pltf
    {
        ...
        public:
            //-----------------------------------------------------------------------------
            ALPAKA_FN_HOST PltfUniformedCudaHipRt() = delete;
        };
    }
    ...
    namespace pltf
    {
        namespace traits
        {
                ...
                pltf::PltfUniformedCudaHipRt>
            {
                ...
                -> dev::DevUniformedCudaHipRt
                {
                    ...
                    std::size_t const devCount(pltf::getDevCount<pltf::PltfUniformedCudaHipRt>());
                    if(devIdx >= devCount)
                    {
        ...
        #if defined(ALPAKA_ACC_GPU_CUDA_ENABLED)
                        uniformedCudaHipDeviceProp devProp;
...
#if defined(ALPAKA_ACC_GPU_CUDA_ENABLED)
                    uniformedCudaHipDeviceProp const & devProp)
#else
