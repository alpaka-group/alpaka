...
namespace alpaka
{
        ...
        namespace traits
        {
                ...
                DevUniformCudaHipRt>
            {
                ...
                ALPAKA_FN_HOST static auto createTaskSet(
                    ...
                    std::uint8_t const & byte,
                    TExtent const & extent)
                -> view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<
                    TDim,
                    TView,
                    TExtent>
                {
    ...
    namespace traits
    {
        ...
        struct Enqueue<
            ...
            view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<1u>, TView, TExtent>>
        {
            //-----------------------------------------------------------------------------
            ALPAKA_FN_HOST static auto enqueue(
                QueueUniformCudaHipRtNonBlocking & queue,
                view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<1u>, TView, TExtent> const & task)
            -> void
            {
        ...
        struct Enqueue<
            QueueUniformCudaHipRtNonBlocking,
            view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<2u>, TView, TExtent>>
        {
            //-----------------------------------------------------------------------------
            ALPAKA_FN_HOST static auto enqueue(
                QueueUniformCudaHipRtNonBlocking & queue,
                view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<2u>, TView, TExtent> const & task)
            -> void
            {
                ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
        ...
        struct Enqueue<
            QueueUniformCudaHipRtNonBlocking,
            view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<3u>, TView, TExtent>>
        {
            //-----------------------------------------------------------------------------
            ALPAKA_FN_HOST static auto enqueue(
                QueueUniformCudaHipRtNonBlocking & queue,
                view::uniform_cuda_hip::detail::TaskSetUniformCudaHip<DimInt<3u>, TView, TExtent> const & task)
            -> void
            {
                ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
