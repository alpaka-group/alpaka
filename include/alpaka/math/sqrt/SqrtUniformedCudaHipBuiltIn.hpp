...
namespace alpaka
{
    namespace math
    {
        //#############################################################################
        //! The CUDA sqrt.
        class SqrtUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathSqrt, SqrtUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Sqrt<
                SqrtUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto sqrt(
                    SqrtUniformedCudaHipBuiltIn const & sqrt_ctx,
                    TArg const & arg)
                {
