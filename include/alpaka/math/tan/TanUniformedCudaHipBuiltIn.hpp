...
namespace alpaka
{
    namespace math
    {
        //#############################################################################
        //! The CUDA tan.
        class TanUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathTan, TanUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Tan<
                TanUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto tan(
                    TanUniformedCudaHipBuiltIn const & tan_ctx,
                    TArg const & arg)
                {
