...
namespace alpaka
{
    namespace math
    {
        ...
        class CbrtUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathCbrt, CbrtUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Cbrt<
                CbrtUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_arithmetic<TArg>::value>>
            {
                __device__ static auto cbrt(
                    CbrtUniformedCudaHipBuiltIn const & cbrt_ctx,
                    TArg const & arg)
                {
