...
namespace alpaka
{
    namespace math
    {
        ...
        class AcosUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathAcos, AcosUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Acos<
                AcosUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto acos(
                    AcosUniformedCudaHipBuiltIn const & acos_ctx,
                    TArg const & arg)
                {
