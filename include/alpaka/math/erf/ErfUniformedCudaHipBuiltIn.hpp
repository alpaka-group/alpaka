...
namespace alpaka
{
    namespace math
    {
        ...
        class ErfUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathErf, ErfUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Erf<
                ErfUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto erf(
                    ErfUniformedCudaHipBuiltIn const & erf_ctx,
                    TArg const & arg)
                {
