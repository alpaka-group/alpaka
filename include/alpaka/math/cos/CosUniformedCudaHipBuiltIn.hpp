...
namespace alpaka
{
    namespace math
    {
        ...
        class CosUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathCos, CosUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Cos<
                CosUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto cos(
                    CosUniformedCudaHipBuiltIn const & cos_ctx,
                    TArg const & arg)
                {
