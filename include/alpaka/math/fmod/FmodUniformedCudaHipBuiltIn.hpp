...
namespace alpaka
{
    namespace math
    {
        ...
        class FmodUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathFmod, FmodUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
                    ...
                    && std::is_floating_point<Ty>::value>>
            {
                __device__ static auto fmod(
                    FmodUniformedCudaHipBuiltIn const & fmod_ctx,
                    Tx const & x,
                    Ty const & y)
                {
