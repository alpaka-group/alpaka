...
namespace alpaka
{
    namespace math
    {
        ...
        class AbsUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathAbs, AbsUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Abs<
                AbsUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto abs(
                    AbsUniformedCudaHipBuiltIn const & abs_ctx,
                    TArg const & arg)
                {
