...
namespace alpaka
{
    namespace math
    {
        //#############################################################################
        //! The CUDA rsqrt.
        class RsqrtUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathRsqrt, RsqrtUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Rsqrt<
                RsqrtUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_arithmetic<TArg>::value>>
            {
                __device__ static auto rsqrt(
                    RsqrtUniformedCudaHipBuiltIn const & rsqrt_ctx,
                    TArg const & arg)
                {
