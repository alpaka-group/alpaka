...
namespace alpaka
{
    namespace math
    {
        //#############################################################################
        //! The CUDA sin.
        class SinUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathSin, SinUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Sin<
                SinUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto sin(
                    SinUniformedCudaHipBuiltIn const & sin_ctx,
                    TArg const & arg)
                {
