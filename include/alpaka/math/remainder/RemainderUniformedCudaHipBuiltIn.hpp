...
namespace alpaka
{
    namespace math
    {
        ...
        class RemainderUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathRemainder, RemainderUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                ...
                typename Ty>
            struct Remainder<
                RemainderUniformedCudaHipBuiltIn,
                Tx,
                Ty,
                std::enable_if_t<
                    ...
                    && std::is_floating_point<Ty>::value>>
            {
                __device__ static auto remainder(
                    RemainderUniformedCudaHipBuiltIn const & remainder_ctx,
                    Tx const & x,
                    Ty const & y)
                {
