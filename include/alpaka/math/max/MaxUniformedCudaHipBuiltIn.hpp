...
namespace alpaka
{
    namespace math
    {
        ...
        class MaxUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathMax, MaxUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
                    ...
                    && std::is_integral<Ty>::value>>
            {
                __device__ static auto max(
                    MaxUniformedCudaHipBuiltIn const & max_ctx,
                    Tx const & x,
                    Ty const & y)
                {
