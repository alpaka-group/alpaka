...
namespace alpaka
{
    namespace math
    {
        ...
        class CeilUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathCeil, CeilUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Ceil<
                CeilUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto ceil(
                    CeilUniformedCudaHipBuiltIn const & ceil_ctx,
                    TArg const & arg)
                {
