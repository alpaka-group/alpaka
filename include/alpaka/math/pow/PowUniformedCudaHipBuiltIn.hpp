...
namespace alpaka
{
    namespace math
    {
        ...
        class PowUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathPow, PowUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
                    ...
                    && std::is_floating_point<TExp>::value>>
            {
                __device__ static auto pow(
                    PowUniformedCudaHipBuiltIn const & pow_ctx,
                    TBase const & base,
                    TExp const & exp)
                {
