...
namespace alpaka
{
    namespace math
    {
        ...
        class AsinUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathAsin, AsinUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Asin<
                AsinUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto asin(
                    AsinUniformedCudaHipBuiltIn const & asin_ctx,
                    TArg const & arg)
                {
