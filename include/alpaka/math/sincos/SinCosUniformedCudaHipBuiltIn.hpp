...
namespace alpaka
{
    namespace math
    {
        //#############################################################################
        //! The CUDA sincos.
        class SinCosUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathSinCos, SinCosUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<>
            struct SinCos<
                SinCosUniformedCudaHipBuiltIn,
                double>
            {
                __device__ static auto sincos(
                    SinCosUniformedCudaHipBuiltIn const & sincos_ctx,
                    double const & arg,
                    double & result_sin,
                    double & result_cos)
                -> void
