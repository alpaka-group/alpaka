...
namespace alpaka
{
    namespace math
    {
        ...
        class MinUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathMin, MinUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
                    ...
                    && std::is_integral<Ty>::value>>
            {
                __device__ static auto min(
                    MinUniformedCudaHipBuiltIn const & min_ctx,
                    Tx const & x,
                    Ty const & y)
                {
