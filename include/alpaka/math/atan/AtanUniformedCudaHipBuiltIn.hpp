...
namespace alpaka
{
    namespace math
    {
        ...
        class AtanUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathAtan, AtanUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Atan<
                AtanUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto atan(
                    AtanUniformedCudaHipBuiltIn const & atan_ctx,
                    TArg const & arg)
                {
