...
namespace alpaka
{
    namespace math
    {
        ...
        class LogUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathLog, LogUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Log<
                LogUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto log(
                    LogUniformedCudaHipBuiltIn const & log_ctx,
                    TArg const & arg)
                {
