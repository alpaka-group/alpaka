...
namespace alpaka
{
    namespace math
    {
        ...
        class ExpUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathExp, ExpUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Exp<
                ExpUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto exp(
                    ExpUniformedCudaHipBuiltIn const & exp_ctx,
                    TArg const & arg)
                {
