...
namespace alpaka
{
    namespace math
    {
        ...
        class FloorUniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathFloor, FloorUniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
            ...
            template<
                typename TArg>
            struct Floor<
                FloorUniformedCudaHipBuiltIn,
                TArg,
                std::enable_if_t<
                    std::is_floating_point<TArg>::value>>
            {
                __device__ static auto floor(
                    FloorUniformedCudaHipBuiltIn const & floor_ctx,
                    TArg const & arg)
                {
