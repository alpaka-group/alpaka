...
namespace alpaka
{
    namespace math
    {
        ...
        class Atan2UniformedCudaHipBuiltIn : public concepts::Implements<ConceptMathAtan2, Atan2UniformedCudaHipBuiltIn>
        {
        };
        ...
        namespace traits
        {
                    ...
                    && std::is_floating_point<Tx>::value>>
            {
                __device__ static auto atan2(
                    Atan2UniformedCudaHipBuiltIn const & atan2_ctx,
                    Ty const & y,
                    Tx const & x)
                {
