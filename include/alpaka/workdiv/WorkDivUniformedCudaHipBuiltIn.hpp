...
namespace alpaka
{
    namespace workdiv
    {
        ...
        template<
            typename TDim,
            typename TIdx>
        class WorkDivUniformedCudaHipBuiltIn : public concepts::Implements<ConceptWorkDiv, WorkDivUniformedCudaHipBuiltIn<TDim, TIdx>>
        {
        public:
            //-----------------------------------------------------------------------------
            __device__ WorkDivUniformedCudaHipBuiltIn(
                vec::Vec<TDim, TIdx> const & threadElemExtent) :
                    m_threadElemExtent(threadElemExtent)
            {}
            //-----------------------------------------------------------------------------
            __device__ WorkDivUniformedCudaHipBuiltIn(WorkDivUniformedCudaHipBuiltIn const &) = delete;
            //-----------------------------------------------------------------------------
            __device__ WorkDivUniformedCudaHipBuiltIn(WorkDivUniformedCudaHipBuiltIn &&) = delete;
            //-----------------------------------------------------------------------------
            __device__ auto operator=(WorkDivUniformedCudaHipBuiltIn const &) -> WorkDivUniformedCudaHipBuiltIn & = delete;
            //-----------------------------------------------------------------------------
            __device__ auto operator=(WorkDivUniformedCudaHipBuiltIn &&) -> WorkDivUniformedCudaHipBuiltIn & = delete;
            //-----------------------------------------------------------------------------
            /*virtual*/ ~WorkDivUniformedCudaHipBuiltIn() = default;

        public:
            // \TODO: Optimize! Add WorkDivUniformedCudaHipBuiltInNoElems that has no member m_threadElemExtent as well as AccGpuUniformedCudaHipRtNoElems.
            // Use it instead of AccGpuUniformedCudaHipRt if the thread element extent is one to reduce the register usage.
    ...
    namespace dim
    {
        namespace traits
        {
            ...
            template<
                ...
                typename TIdx>
            struct DimType<
                workdiv::WorkDivUniformedCudaHipBuiltIn<TDim, TIdx>>
            {
                using type = TDim;
            };
        }
    ...
    namespace workdiv
    {
        namespace traits
        {
            ...
            template<
                ...
                typename TIdx>
            struct GetWorkDiv<
                WorkDivUniformedCudaHipBuiltIn<TDim, TIdx>,
                origin::Grid,
                unit::Blocks>
            {
                //-----------------------------------------------------------------------------
                ...
                __device__ static auto getWorkDiv(
                    WorkDivUniformedCudaHipBuiltIn<TDim, TIdx> const & workDiv)
                -> vec::Vec<TDim, TIdx>
                {
