...
// Base classes.
#include <alpaka/workdiv/WorkDivUniformedCudaHipBuiltIn.hpp>
#include <alpaka/idx/gb/IdxGbUniformedCudaHipBuiltIn.hpp>
#include <alpaka/idx/bt/IdxBtUniformedCudaHipBuiltIn.hpp>
#include <alpaka/atomic/AtomicUniformedCudaHipBuiltIn.hpp>
#include <alpaka/atomic/AtomicHierarchy.hpp>
#include <alpaka/math/MathUniformedCudaHipBuiltIn.hpp>
#include <alpaka/block/shared/dyn/BlockSharedMemDynUniformedCudaHipBuiltIn.hpp>
#include <alpaka/block/shared/st/BlockSharedMemStUniformedCudaHipBuiltIn.hpp>
#include <alpaka/block/sync/BlockSyncUniformedCudaHipBuiltIn.hpp>
#include <alpaka/rand/RandUniformedCudaHipRand.hpp>
#include <alpaka/time/TimeUniformedCudaHipBuiltIn.hpp>
...
namespace alpaka
{
    ...
    namespace acc
    {
        ...
        template<
            typename TDim,
            typename TIdx>
        class AccGpuUniformedCudaHipRt :
            public workdiv::WorkDivUniformedCudaHipBuiltIn<TDim, TIdx>,
            public idx::gb::IdxGbUniformedCudaHipBuiltIn<TDim, TIdx>,
            public idx::bt::IdxBtUniformedCudaHipBuiltIn<TDim, TIdx>,
            public atomic::AtomicHierarchy<
                atomic::AtomicUniformedCudaHipBuiltIn, // grid atomics
                atomic::AtomicUniformedCudaHipBuiltIn, // block atomics
                atomic::AtomicUniformedCudaHipBuiltIn  // thread atomics
            >,
            public math::MathUniformedCudaHipBuiltIn,
            public block::shared::dyn::BlockSharedMemDynUniformedCudaHipBuiltIn,
            public block::shared::st::BlockSharedMemStUniformedCudaHipBuiltIn,
            public block::sync::BlockSyncUniformedCudaHipBuiltIn,
            public rand::RandUniformedCudaHipRand,
            public time::TimeUniformedCudaHipBuiltIn
        {
        public:
            //-----------------------------------------------------------------------------
            __device__ AccGpuUniformedCudaHipRt(
                vec::Vec<TDim, TIdx> const & threadElemExtent) :
                    workdiv::WorkDivUniformedCudaHipBuiltIn<TDim, TIdx>(threadElemExtent),
                    idx::gb::IdxGbUniformedCudaHipBuiltIn<TDim, TIdx>(),
                    idx::bt::IdxBtUniformedCudaHipBuiltIn<TDim, TIdx>(),
                    atomic::AtomicHierarchy<
                        atomic::AtomicUniformedCudaHipBuiltIn, // atomics between grids
                        atomic::AtomicUniformedCudaHipBuiltIn, // atomics between blocks
                        atomic::AtomicUniformedCudaHipBuiltIn  // atomics between threads
                    >(),
                    math::MathUniformedCudaHipBuiltIn(),
                    block::shared::dyn::BlockSharedMemDynUniformedCudaHipBuiltIn(),
                    block::shared::st::BlockSharedMemStUniformedCudaHipBuiltIn(),
                    block::sync::BlockSyncUniformedCudaHipBuiltIn(),
                    rand::RandUniformedCudaHipRand(),
                    time::TimeUniformedCudaHipBuiltIn()
            {}

        public:

            //using baseType = AccUniformedCudaHip<TDim,TIdx>;
        ...
        namespace traits
        {
                ...
                acc::AccGpuUniformedCudaHipRt<TDim, TIdx>>
            {
                ...
                -> acc::AccDevProps<TDim, TIdx>
                {
                    ...
                    // Reading only the necessary attributes with cudaDeviceGetAttribute is faster than reading all with uniformedCudaHipGetDeviceProperties
                    // https://devblogs.nvidia.com/uniformedCudaHip-pro-tip-the-fast-way-to-query-device-properties/
    ...
    namespace kernel
    {
        namespace detail
        {
            ...
            // The execution task TaskKernelGpuUniformedCudaHipRt is therefore performing this check on device side.
            template<
                typename TDim,
                typename TIdx>
            struct CheckFnReturnType<
                acc::AccGpuUniformedCudaHipRt<
                    TDim,
                    TIdx>>
            {
                template<
