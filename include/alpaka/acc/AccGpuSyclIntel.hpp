...
namespace alpaka::trait
{
    ...
    struct CreateTaskKernel<AccGpuSyclIntel<TDim, TIdx>, TWorkDiv, KernelBundle<TKernelFnObj, TArgs...>>
    {
        ALPAKA_FN_HOST static auto createTaskKernel(
            TWorkDiv const& workDiv,
            KernelBundle<TKernelFnObj, TArgs...> const& kernelBundle)
        {
            return TaskKernelGpuSyclIntel<TDim, TIdx, TKernelFnObj, TArgs...>(workDiv, kernelBundle);
        }
    };
