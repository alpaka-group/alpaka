...
namespace alpaka
{
        ...
        namespace serial
        {
            ...
            namespace detail
            {
                ...
                public:
                    ...
                    friend class ::alpaka::accs::serial::detail::KernelExecSerial;
    ...
    namespace traits
    {
        namespace acc
        {
            ...
            template<>
            struct AccType<
                accs::serial::detail::KernelExecSerial>
            {
        ...
        namespace exec
        {
            ...
            struct ExecType<
                accs::serial::detail::AccSerial>
            {
                using type = accs::serial::detail::KernelExecSerial;
            };
        }
        ...
        namespace stream
        {
                ...
                accs::serial::detail::KernelExecSerial>
            {
                ALPAKA_FCT_HOST static auto getStream(
                    accs::serial::detail::KernelExecSerial const &)
