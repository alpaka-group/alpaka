    ...
    namespace serial
    {
        namespace detail
        {
            ...
            public:
                ...
                //! Default-constructor.
                //-----------------------------------------------------------------------------
                ACC_FCT_CPU_CUDA IndexSerial() = default;

                //-----------------------------------------------------------------------------
                //! Copy-onstructor.
                //-----------------------------------------------------------------------------
                ACC_FCT_CPU_CUDA IndexSerial(IndexSerial const & other) = default;
            ...
            using TPackedIndex = acc::detail::IIndex<IndexSerial>;
