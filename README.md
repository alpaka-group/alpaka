...
| Accelerator Back-end                                                           | gcc 9.5 <br/> (Linux)                       | gcc 10.4 / 11.2 <br/> (Linux)               | gcc 12.2 <br/> (Linux)               | clang 9 <br/> (Linux)                                  | clang 10 / 11<br/> (Linux)                              | clang 12 <br/> (Linux)                           | clang 13 <br/> (Linux)                      | clang 14 <br/> (Linux)                            | clang 15 <br/> (Linux)                | icpx (latest)      | Xcode 13.2.1 / 14.2 <br /> (macOS)                    | Visual Studio 2022 <br/> (Windows)   |
|--------------------------------------------------------------------------------|---------------------------------------------|---------------------------------------------|--------------------------------------|--------------------------------------------------------|---------------------------------------------------------|--------------------------------------------------|---------------------------------------------|---------------------------------------------------|---------------------------------------|--------------------|-------------------------------------------------------|--------------------------------------|
...
| OpenMP 2.0+ blocks                                                             | :white_check_mark:                          | :white_check_mark:                          | :white_check_mark:                   | :white_check_mark:                                     | :white_check_mark:                                      | :white_check_mark:                               | :white_check_mark:                          | :white_check_mark:                                | :white_check_mark:                    | :white_check_mark: | :white_check_mark:                                    | :white_check_mark:                   |
| OpenMP 2.0+ threads                                                            | :white_check_mark:                          | :white_check_mark:                          | :white_check_mark:                   | :white_check_mark:                                     | :white_check_mark:                                      | :white_check_mark:                               | :white_check_mark:                          | :white_check_mark:                                | :white_check_mark:                    | :white_check_mark: | :white_check_mark:                                    | :white_check_mark:                   |
| OpenMP 5.0 (CPU)                                                               | :x:                                         | :x:                                         | :white_check_mark:                   | :x:                                                    | :x:                                                     | :white_check_mark:                               | :white_check_mark:                          | :white_check_mark:                                | :white_check_mark:                    | :white_check_mark: | :white_check_mark:                                    | :x:                                  |
...
| CUDA (nvcc)                                                                    | :white_check_mark: <br/> (CUDA 11.0 - 12.0) | :white_check_mark: <br/> (CUDA 11.4 - 12.0) | :white_check_mark: <br/> (CUDA 12.0) | :white_check_mark: <br/> (CUDA 11.0-11.2; 11.6 - 12.0) | :white_check_mark: <br/> (CUDA 11.2, 11.6 - 12.0)       | :white_check_mark: <br/> (CUDA 11.6 - 12.0)      | :white_check_mark: <br/> (CUDA 11.7 - 12.0) | :white_check_mark: <br/> (CUDA 11.8 - 12.0)       | :x:                                   | :x:                | :x:                                                   | :white_check_mark: <br/> (CUDA 12.0) |
| CUDA (clang)                                                                   | -                                           | -                                           | -                                    | :x:                                                    | :x:                                                     | :x:                                              | :x:                                         | :white_check_mark: (CUDA 11.0 - 11.5)             | :white_check_mark: (CUDA 11.0 - 11.5) | :x:                | -                                                     | -                                    |
| [HIP](https://alpaka.readthedocs.io/en/latest/install/HIP.html) (clang)        | -                                           | -                                           | -                                    | :x:                                                    | :x:                                                     | :x:                                              | :x:                                         | :white_check_mark: (HIP 5.0 - 5.2)                | :white_check_mark: (HIP 5.3 - 5.4)    | :x:                | -                                                     | -                                    |
