...
| CUDA (nvcc)                                                                    | :white_check_mark: <br/> (CUDA 11.0 - 12.2) | :white_check_mark: <br/> (CUDA 11.4 - 12.0) | :white_check_mark: <br/> (CUDA 12.0 - 12.2) | :x:                    | :white_check_mark: <br/> (CUDA 11.0-11.2; 11.6 - 12.0) | :white_check_mark: <br/> (CUDA 11.2, 11.6 - 12.0)       | :white_check_mark: <br/> (CUDA 11.6 - 12.0)      | :white_check_mark: <br/> (CUDA 11.7 - 12.0) | :white_check_mark: <br/> (CUDA 11.8 - 12.0)       | :white_check_mark: <br/> (CUDA 12.2)      | :x:                                       | :x:                | :x:                                                   | :x:                                  |
