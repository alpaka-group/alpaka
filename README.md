...
|Accelerator Back-end|gcc 4.9.2|gcc 5.4|gcc 6.2/7.1|clang 3.5/3.6|clang 3.7|clang 3.8|clang 3.9|clang 4/5|MSVC 2015.3/2017.3|
|---|---|---|---|---|---|---|---|---|---|
...
|CUDA 7.0+|:white_check_mark: (nvcc 7.0+)|:white_check_mark: (nvcc 8.0+)|:x:|:x:|:x:|:white_check_mark: (nvcc 8.0+)|:white_check_mark: (native)|:x:|:x:|
