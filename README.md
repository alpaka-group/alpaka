...
|CUDA 7.0-9.1|CUDA 7.0-9.1|NVIDIA GPUs SM 2.0+|parallel (undefined)|parallel (lock-step within warps)|
...
|CUDA 7.0-9.1|:white_check_mark: (nvcc 7.0-9.1)|:white_check_mark: (nvcc 9.0-9.1)|:x:|:white_check_mark: (nvcc 8.0+)|:white_check_mark: (nvcc 8.0+)|:white_check_mark: (native/nvcc 9.1)|:white_check_mark: (native/nvcc 9.1)|:white_check_mark: (native)|:x:|
