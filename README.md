...
|CUDA|:white_check_mark: (nvcc 7.0-9.2)|:white_check_mark: (nvcc 9.0-9.2)|:white_check_mark: (nvcc 9.2)|:white_check_mark: (nvcc 8.0+)|:white_check_mark: (nvcc 8.0+)|:white_check_mark: (native CUDA 8.0/nvcc 9.1-9.2)|:white_check_mark: (native CUDA 8.0)|:white_check_mark: (native CUDA 8.0-9.0)|:x:|
