...
| Accelerator Back-end                                                           | gcc 9.5 <br/> (Linux)                     | gcc 10.3 <br/> (Linux)               | gcc 11.1 <br/> (Linux) | gcc 12.2 <br/> (Linux) | clang 9 <br/> (Linux)                           | clang 10 <br/> (Linux)                           | clang 11 <br/> (Linux)                    | clang 12 <br/> (Linux)                    | clang 13 <br/> (Linux)               | clang 14 <br/> (Linux)                            | icpx (latest)      | Xcode 13.2.1/13.4.1 <br /> (macOS)                    | Visual Studio 2022 <br/> (Windows)   |
|--------------------------------------------------------------------------------|-------------------------------------------|--------------------------------------|------------------------|------------------------|-------------------------------------------------|--------------------------------------------------|-------------------------------------------|-------------------------------------------|--------------------------------------|---------------------------------------------------|--------------------|-------------------------------------------------------|--------------------------------------|
...
| OpenMP 5.0 (CPU)                                                               | :x:                                       | :x:                                  | :x:                    | :white_check_mark:     | :x:                                             | :x:                                              | :white_check_mark:                        | :white_check_mark:                        | :white_check_mark:                   | :white_check_mark:                                | :white_check_mark: | :white_check_mark:                                    | :x:                                  |
...
| CUDA (nvcc)                                                                    | :white_check_mark: <br/> (CUDA 11.0-11.6) | :white_check_mark: <br/> (CUDA 11.6) | :x:                    | :x:                    | :white_check_mark: <br/> (CUDA 11.0-11.2; 11.6) | :white_check_mark: <br/> (CUDA 11.1, 11.2, 11.6) | :white_check_mark: <br/> (CUDA 11.6)      | :white_check_mark: <br/> (CUDA 11.6)      | :white_check_mark: <br/> (CUDA 11.6) | :x:                                               | :x:                | :x:                                                   | :white_check_mark: <br/> (CUDA 11.6) |
...
| [HIP](https://alpaka.readthedocs.io/en/latest/install/HIP.html) (clang)        | :x:                                       | :x:                                  | :x:                    | :x:                    | :x:                                             | :x:                                              | :x:                                       | :x:                                       | :x:                                  | :white_check_mark: (HIP 5.0 - 5.3)                | :x:                | -                                                     | -                                    |
