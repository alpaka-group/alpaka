    ...
    ELSE()
        ...
        ELSE()
            ...
            IF(ALPAKA_CUDA_COMPILER MATCHES "clang")
                ...
                #LIST(APPEND _ALPAKA_COMPILE_OPTIONS_PUBLIC "-fcuda-allow-host-calls-from-host-device")
                #LIST(APPEND _ALPAKA_COMPILE_OPTIONS_PUBLIC "-fcuda-disable-target-call-checks")
                #LIST(APPEND _ALPAKA_COMPILE_OPTIONS_PUBLIC "-fcuda-target-overloads")
                #LIST(APPEND _ALPAKA_COMPILE_OPTIONS_PUBLIC "-Wno-cuda-compat")
