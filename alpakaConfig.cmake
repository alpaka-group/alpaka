                ...
                ELSEIF("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
                    IF(CUDA_VERSION VERSION_EQUAL 8.0)
                        IF(CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 4.0)
                            MESSAGE(FATAL_ERROR "NVCC 8.0 does not support clang 4+. Please use clang 3.9!")
                        ENDIF()
                    ELSEIF(CUDA_VERSION VERSION_EQUAL 9.0)
                        IF(CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 4.0)
                            MESSAGE(FATAL_ERROR "NVCC 9.0 does not support clang 4+. Please use clang 3.9!")
                        ENDIF()
                    ...
                    ELSEIF(CUDA_VERSION VERSION_EQUAL 9.2)
                        IF(CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 6.0)
                            MESSAGE(FATAL_ERROR "NVCC 9.2 does not support clang 6+. Please use clang 4 or 5!")
                        ENDIF()
                    ENDIF()
                ENDIF()
