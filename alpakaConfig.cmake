...
OPTION(ALPAKA_ACC_CPU_BT_OPENACC2_ENABLE "Enable the OpenACC 2.0 CPU back-end" OFF)
...
IF(ALPAKA_ACC_GPU_CUDA_ONLY_MODE AND
    ...
    ALPAKA_ACC_CPU_BT_OPENACC2_ENABLE))
...
# Find OpenACC.
#-------------------------------------------------------------------------------
IF(ALPAKA_ACC_CPU_BT_OPENACC2_ENABLE)
    FIND_PACKAGE(OpenACC)

    IF(NOT OPENACC_FOUND)
        MESSAGE(WARNING "Optional alpaka dependency OpenACC could not be found! OpenACC back-ends disabled!")
        SET(ALPAKA_ACC_CPU_BT_OPENACC2_ENABLE OFF CACHE BOOL "Enable the OpenACC 2.0 CPU back-end" FORCE)

    ELSE()
        LIST(APPEND _ALPAKA_COMPILE_OPTIONS_PUBLIC ${OpenACC_C_FLAGS})
    ENDIF()
ENDIF()
...
ENDIF()
IF(ALPAKA_ACC_CPU_BT_OPENACC2_ENABLE)
    LIST(APPEND _ALPAKA_COMPILE_DEFINITIONS_PUBLIC "ALPAKA_ACC_CPU_BT_OPENACC2_ENABLED")
    MESSAGE(STATUS ALPAKA_ACC_CPU_BT_OPENACC2_ENABLED)
ENDIF()
IF(ALPAKA_ACC_GPU_CUDA_ENABLE)
